...
* **Menu** - it starts with a slogan and an image of the most iconic drinks of the cafe that makes them different. Then there are four sections giving information about the hot, cold, alcoholic drinks and bubble tea selection with a photo and a text followed by a dropdown of the drinks range. 
...
- Iphone 7,8 and 11- issues with header and some images, address set to diaplay:none and images replaced with alt wallpaper.
- Samsung Galaxy
- Huawei P40
---
# Deployment
...
- Navbar- the navbar was taking too much of the screen space on mobile devices and I had to use a Bootstrap snippet for a Burger Menu to make it more user friendly
